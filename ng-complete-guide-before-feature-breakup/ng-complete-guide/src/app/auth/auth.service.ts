...
export class AuthService {
  ...
  signUpEndPoint:string = 
    "https://identitytoolkit.googleapis.com/v1/accounts:signUp?key=AIzaSyDNsjN_GLmnAgd7BLFYelDdnf_ZBgA47gM";
  signInEndPoint:string = 
    "https://identitytoolkit.googleapis.com/v1/accounts:signInWithPassword?key=AIzaSyDNsjN_GLmnAgd7BLFYelDdnf_ZBgA47gM"
